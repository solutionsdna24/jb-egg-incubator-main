...
import { REGIONAL_LANDING_PAGES } from "./regionalLandingPages";
...
export interface LandingProductLink {
  label: string;
  path: string;
}
...
export interface LandingPage {
  ...
  /** Regional pages — real delivery stories for local SEO */
  deliveryExamples?: DeliveryExample[];
  productLinks?: LandingProductLink[];
}

const p = (paths: string[]) => paths;

const KEYWORD_LANDING_PAGES: LandingPage[] = [
  {
...
export const landingPages: LandingPage[] = [...KEYWORD_LANDING_PAGES, ...REGIONAL_LANDING_PAGES];
